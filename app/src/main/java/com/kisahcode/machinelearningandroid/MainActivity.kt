...
class MainActivity : AppCompatActivity() {
    ...
    /**
     * Analyzes the image located at the given URI and starts the ResultActivity to display the analysis result.
     *
    ...
    private fun analyzeImage(uri: Uri) {
        ...
        // Pass the URI of the current image to the ResultActivity
