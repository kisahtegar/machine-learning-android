...
class CameraActivity : AppCompatActivity() {
     ...
     *
     * This function initializes the camera provider, sets up the preview configuration, and binds the camera
     * to the activity's lifecycle. In case of any errors, it displays a toast message with the error
